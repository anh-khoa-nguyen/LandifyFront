    ...
    return SizedBox(
      ...
      child: Stack(
        children: [
          ...
          AuthHeaderBanner(
            height: 250,
            imagePath: 'assets/images/report_banner.png',
          ),
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          // Thêm phụ đề
          Text(
            'Vui lòng kiểm tra kĩ thông tin trước khi thực hiện báo cáo bài đăng này  .',
          ...
          const Text('Nội dung vi phạm:', style: TextStyle(fontWeight: FontWeight.w600, fontSize: 18)),
          const SizedBox(height: 8),
          Container(
